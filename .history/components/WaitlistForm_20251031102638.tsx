      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto items-start">
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            {/* Urgency Box */}
            <div className="bg-linear-to-r from-red-50 to-orange-50 border-2 border-red-300 rounded-2xl p-5 md:p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            {/* Zero Risk Box */}
            <div className="bg-green-50 border-2 border-green-300 rounded-2xl p-5 md:p-6 hover:shadow-lg transition-shadow">
              <div className="flex items-start gap-3">
