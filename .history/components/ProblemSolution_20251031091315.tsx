      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {problems.map((item, index) => (
            <div 
              key={index} 
              className="grid md:grid-cols-2 gap-8 bg-linear-to-br from-slate-50 to-slate-100 rounded-2xl p-8 border border-slate-200 hover:border-indigo-300 hover:shadow-lg transition-all"
            >
              {/* Problem */}
