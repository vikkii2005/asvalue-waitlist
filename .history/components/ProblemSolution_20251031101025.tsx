      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {problems.map((item, index) => (
            <div 
              key={index} 
              className="bg-linear-to-br from-slate-50 via-slate-50 to-slate-100 rounded-2xl p-8 border-2 border-slate-200 hover:border-indigo-300 hover:shadow-2xl transition-all duration-300 group"
            >
